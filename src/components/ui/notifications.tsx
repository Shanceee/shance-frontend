...
const NotificationItem: React.FC<{
  ...
  return (
    <div
      className={cn(
        'flex items-start p-4 mb-3 rounded-lg shadow-lg border-l-4 transition-all duration-300 ease-in-out transform',
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-medium text-gray-900 mb-1 font-unbounded">
          {title}
        </p>
        <p className="text-sm text-gray-600 font-montserrat">{message}</p>
      </div>
    ...
    <div className="fixed top-4 right-4 z-50 w-96 max-w-sm">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className="text-xs text-gray-500 hover:text-gray-700 transition-colors font-montserrat"
        >
          Очистить все
        </button>
      </div>
